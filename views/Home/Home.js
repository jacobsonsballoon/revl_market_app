            ...
            <View style={{ height: '100%', }}>
                ...
                <Footer>
                    <FooterTab style={{ backgroundColor: '#010001', justifyContent: "center" }}>
                        ...
                        >
                            <Icon name="alpha-m" size={24} style={{ color: this.state.page == 'News' ? '#ffffff' : '#797e86', }}/>
                    ...
                    <FooterTab style={{ backgroundColor: '#010001', justifyContent: "center" }}>
                        ...
                        >
                            <Icon name="account-badge" size={24} style={{ color: this.state.page == 'Shop' ? '#ffffff' : '#797e86', }}/>
                    ...
                    <FooterTab style={{ backgroundColor: '#010001', justifyContent: "center" }}>
                        ...
                        >
                            <Icon name="tablet-cellphone" size={24} style={{ color: this.state.page == 'Profile' ? '#ffffff' : '#797e86', }}/>
